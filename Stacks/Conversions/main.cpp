    ...
    do
    {
        ...
        else if (choice == 2)
        {
            ...
            do
            {
                ...
                {
                    if (postfix[i] != '+' || postfix[i] != '-' || postfix[i] != '*' || postfix[i] != '/' || postfix[i] != '^' || isalpha(postfix[i]))
                    {
                        cout << "Invalid character in postfix expression. Only digits and operators are allowed." << endl;
                        postfix = "";
                        break;
                    }
                }
